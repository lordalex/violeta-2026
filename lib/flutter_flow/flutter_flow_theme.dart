...
abstract class FlutterFlowTheme {
  ...
  static const double maxTextScaleFactor = 16.0;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF200030);
  late Color secondary = const Color(0xFFD04870);
  late Color tertiary = const Color(0xFFEAE3EB);
