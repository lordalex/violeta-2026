...
import 'directorio_municipios2_model.dart';
export 'directorio_municipios2_model.dart';

class DirectorioMunicipios2Widget extends StatefulWidget {
  const DirectorioMunicipios2Widget({
    super.key,
    required this.url,
  });
  ...
  static String routeName = 'directorioMunicipios2';
  static String routePath = '/directorioMunicipios2';

  @override
  State<DirectorioMunicipios2Widget> createState() =>
      _DirectorioMunicipios2WidgetState();
}

class _DirectorioMunicipios2WidgetState
    extends State<DirectorioMunicipios2Widget> with TickerProviderStateMixin {
  late DirectorioMunicipios2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DirectorioMunicipios2Model());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.dirFileNameList = functions
          .findallkeys('municipio', _model.fileContent!)
          .toList()
          .cast<String>();
      safeSetState(() {});
    });
                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide(
                        color:
                            (_model.buscarFocusNode?.hasFocus ?? false) == null
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final municipios = _model.dirFileNameList.toList();

                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            children: List.generate(municipios.length,
                                (municipiosIndex) {
                              final municipiosItem =
                                  municipios[municipiosIndex];
                              return Align(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            context.pushNamed(
                                              DirectorioListadoServicios3Widget
                                                  .routeName,
                                              queryParameters: {
                                                'url': serializeParam(
                                                  widget.url,
